...
function RepMMod:PortalUse(item, RNG, EntityPlayer, Flags, ActiveSlot)
    ...
    for _, entity in ipairs(roomEntities) do
        if entity.Type == 5 then
			...
			elseif entity.Variant == 50 or entity.Variant == 52 or entity.Variant == 51 or entity.Variant == 53 or entity.Variant == 54 or entity.Variant == 55 or entity.Variant == 56 or entity.Variant == 57 or entity.Variant == 58 or entity.Variant == 60 or entity.Variant == 390 or entity.Variant == 360 then
				if entity.SubType == 0 then
				else
					table.insert(saveTable.PortalD6, {Variant = entity.Variant, SubType = entity.SubType, Position = entity.Position, price = entity:ToPickup().Price, roomType = roomsList:Get(math.random(0, roomsList.Size-1)).Data.Type})
					Isaac.Spawn(1000, 15, 0, entity.Position, Vector.Zero, entity)
			...
			elseif entity.Variant == 370 or entity.Variant == 380 or entity.Variant == 340 or entity.Variant == 150 or entity.Variant == 110 or entity.Variant == 41 then
			else
